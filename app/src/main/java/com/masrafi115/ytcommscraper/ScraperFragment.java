...
public class ScraperFragment extends Fragment {
    ...
    private static final String TAG = "ScraperDemo";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        videoId = view.findViewById(R.id.ytid);
        if (sharedLink != null) {
            videoId.setText(sharedLink);
        }
        ...
        Button scrapButton = view.findViewById(R.id.button);
        ...
        scrapButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (videoId.getText().toString().isEmpty()) {
                    videoId.setError("Please enter video link...");
                    hideProgressingView();
                    return;
                }

                if (isYoutubeUrl(videoId.getText().toString()) == false) {
                    ...
                    if (flag == 0) {
                        String id = getVideoId(videoId.getText().toString());
                        /*
    ...
    private void getSuperHeroes(String id) {
        Call<Results> call = RetrofitClient.getInstance().getMyApi().getsuperHeroes("AIzaSyAbfxyKBnnSKsBho6k8C2OSFdJNk8NAy9w", "plainText", "snippet", 1000000000, id);
